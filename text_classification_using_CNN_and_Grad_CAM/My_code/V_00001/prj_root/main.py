...
# cd /mnt/1T-5e7/Companies/Sakary/Management_by_files/00002_Architecture_specific_projects/00002_Grad_CAM_on_text_classification/My_code/V_00001/prj_root
...
# --optimizer=None \
# --network_type="CNN_for_text_classification" \
# --dropout=0.5 \
...
from src.module_classify_docs import classify_docs_by_using_vocab as classify_docs_by_using_vocab
...
def start_train(args):
  # print("train_method",args.train_method)
  # xgboost_one_hot
...
# ================================================================================
def start_classify_docs(args):
  if args.classify_docs_method=="use_vocab":
    classify_docs_by_using_vocab.train(args)
...
if __name__=="__main__":
  ...
  if args.start_mode=="preanalyze_data":
    ...
    start_train(args)
  elif args.start_mode=="classify_docs":
    start_classify_docs(args)
